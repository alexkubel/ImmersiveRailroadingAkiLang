...
public class RailSettings {
    ...
    public RailSettings(Gauge gauge, String track, TrackItems type, TrackItems pickType, int length, float degrees, float curvosity, TrackSmoothing smoothing, EndPointData nearPointData, EndPointData farPointData, RollAndOffsetInfo rollAndOffsetInfo, RollAndOffsetInfo pickRollAndOffsetInfo, TrackDirection direction, ItemStack railBed, ItemStack railBedFill, boolean isPreview, boolean isGradeCrossing, int count, int spacing) {
        this(gauge, track, type, length, degrees, curvosity, smoothing, direction, railBed, railBedFill, isPreview, isGradeCrossing, count, spacing, 1, 4);
    }
    ...
    public RailSettings(Gauge gauge, String track, TrackItems type, int length, float degrees, float curvosity, TrackSmoothing smoothing, EndPointData nearPointData, EndPointData farPointData, RollAndOffsetInfo rollAndOffsetInfo, RollAndOffsetInfo pickRollAndOffsetInfo,TrackDirection direction, ItemStack railBed, ItemStack railBedFill, boolean isPreview, boolean isGradeCrossing, int count, int spacing, int parallelCount, float parallelGap) {
        this(gauge, track, type, length, degrees, curvosity, smoothing, direction, railBed, railBedFill, 1, 0, 1, 1, false, 0, 4, 1, isPreview, isGradeCrossing, count, spacing, parallelCount, parallelGap);
    }
